    ...
    <div className="ritual-home">
      ...
      <main>
        ...
        <section className="object" id="lume">
          <div className="wrap object-grid"><div className="lamp-stage" role="img" aria-label="A softly glowing Lume lamp"><div className="lamp"><div className="shade" /><div className="stem" /><div className="base" /></div></div><div className="object-copy"><p className="eyebrow mono">Our first expression / Lume</p><h2>Light for the <em>small hours.</em></h2><p style={{ marginTop: 28 }}>A sleep-spectrum lamp made for the part of the day that belongs to you. Thoughtful light, considered materials, no noise.</p><a className="linkline" href="#lab">Discover Lume <span>→</span></a></div></div>
        </section>
